...
import { Plus, MessageSquare, Calendar, Search, MoreHorizontal } from 'lucide-react';
  ...
  if (isLoading) {
    return (
      <div className="w-80 h-full bg-[#1a1a1a] border-r border-[#2a2a2a] flex items-center justify-center">
        <div className="text-[#888888]">Loading conversations...</div>
      </div>
    );
  }
    ...
    <div className="w-80 h-full bg-[#1a1a1a] border-r border-[#2a2a2a] flex flex-col">
      ...
      <div className="p-4 border-b border-[#2a2a2a]">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#888888]">Your conversations</p>
            </div>
          </div>
        </div>
        ...
        <Button 
          ...
          className="w-full bg-[#ffd700] hover:bg-[#ffd700]/80 text-black font-medium"
